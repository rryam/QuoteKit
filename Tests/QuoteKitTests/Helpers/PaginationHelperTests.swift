...
struct PaginationHelperTests {
  ...
  @Test func testNextPageWhenMorePagesExist() {
    ...
    for testCase in testCases {
      ...
      #expect(
        nextPage == testCase.expectedNext,
        "\(testCase.description): Expected page \(testCase.expectedNext) but got \(String(describing: nextPage))"
      )
    }
  }
  ...
  @Test func testNextPageEdgeCases() {
    ...
    for testCase in edgeCases {
      ...
      #expect(
        nextPage == testCase.expectedNext,
        "\(testCase.description): Expected \(String(describing: testCase.expectedNext)) but got \(String(describing: nextPage))"
      )
    }
  }
